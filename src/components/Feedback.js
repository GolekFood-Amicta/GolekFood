    ...
    render() {
        return (
            <div className="z-[999] shadow fixed m-auto top-0 bottom-0 right-0 left-0 w-1/2 h-5/6 rounded-3xl p-8 bg-white">
                ...
                <form className="h-2/3 flex flex-col justify-around">
                    <input value={this.state.subject} onChange={this.onSubjectChangeEventHandler} placeholder="Subjek" className="w-full border-2 border-black rounded-xl p-4 accent-transparent" />
                    <textarea value={this.state.content} onChange={this.onContentChangeEventHandler} placeholder="Tulis masukanmu tentang GolekFoods disini..." className="w-full h-1/2 resize-none border-2 border-black rounded-xl p-4 accent-transparent" />
