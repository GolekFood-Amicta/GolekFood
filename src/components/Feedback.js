    ...
    render() {
        return (
            <div className="z-[999] shadow fixed m-auto top-0 bottom-0 right-0 left-0 w-1/2 h-5/6 rounded-3xl p-8 bg-white">
                ...
                <p className="text-center font-semibold text-lg text-GF-green">Feedback</p>
                <p className="text-center text-GF-grey my-8">We value your opinion, help us improve with your <span className="font-bold">feedback</span></p>
