            ...
            <div className="flex">
                ...
                <div className="w-full h-screen">
                    ...
                    <div className="w-11/12">
                        <p className="text-xl font-bold mb-4">Welcome to GolekFoods, <br />Sign Up to Continue </p>
                        ...
                        <button className="w-full bg-black text-white py-4 rounded-xl hover:bg-GF-green">Sign Up</button>
                    </div>
                </div>
            </div>
        );
